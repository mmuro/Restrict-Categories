		...
		<div class="wrap">
            ...
            ?>
                <fieldset>
                    ...
                    <!-- Filter Box -->
					<div id="side-sortables" class="metabox-holder" style="padding:5px;"> 
	                    <div class="postbox">
	                    	<h3 class="hndle"><span>Filter by roles</span></h3>
		               		<div class="inside" style="padding:0 10px;">
			                	<form action=""> 
			                		<input type="checkbox"  id="toggleBoxes-all" value="all" checked="checked"> <label for="toggleBoxes-all">Show all</label><br />
			                		<?php foreach($all_roles as $role): ?>

			                				<input type="checkbox" id="toggleBoxes-<?php echo $role; ?>" value="<?php echo $role; ?>" checked="checked">
			                				<label for="toggleBoxes-<?php echo $role; ?>"><?php echo $role; ?> </label>
	...
	public function start_box($settings, $options, $options_name){
		...
		foreach ( $options as $key => $value ) :
			...
			if ( isset( $_REQUEST['type'] ) && $_REQUEST['type'] == 'users' ) {
				...
				$user = get_user_by( 'login', $value['name'] );
				$user_role = array_values( $user->roles )[0];
			}
		...
		?>
			<div id="side-sortables" class="metabox-holder" style="float:left; padding:5px;"> 
				<div class="userlevel-<?php echo $user_role; ?> postbox">
